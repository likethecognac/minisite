...
function useCanvas(props) {
  ...
  React.useLayoutEffect(function () {
    ...
    }, typeof children === 'function' ? children(state.current) : children)), defaultScene, state); // React Hook React.useLayoutEffect has an unnecessary dependency: 'sharedState.current'. Either exclude it or remove the dependency array. Mutable values like 'sharedState.current' aren't valid dependencies because mutating them doesn't re-render the component.
    // eslint-disable-next-line react-hooks/exhaustive-deps
